  ...
  beforeEach(() => {
    ...
    component.pli = new TripPackingListItem({
      ...
      item: {
        ...
        remarks_zh: '',
        description:
          'Do not bring any knives, blades, or firearms, even fake ones like cap guns. They will cause you huge headaches with your teachers and airport security!',
        description_zh:
          '请勿携带刀、剑或任何武器，包括仿真枪。这类物品会给您自己带来很大的麻烦，不管是您的老师还是机场保安都不会放过您的！',
        footer: '',
        footer_zh: '',
        image: 'weapons.png',
        bring: 2,
